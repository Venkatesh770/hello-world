...
N = 4 # number of disks/spheres
xs = np.array([0.51,0.15,0.93,0.93]) # x coordinates
ys = np.array([0.53,0.3,0.3,0.51]) # y coordinates
rs = np.array([0.05,0.05,0.05,0.05]) # radii
